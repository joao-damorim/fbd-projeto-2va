<div class="container theme-showcase" role="main">
  ...
  <div class="page-header">
	<h1>Cadastrar Funcionário ADM</h1>
  </div>
	...
	<div class="col-md-12">
		<form class="form-horizontal" method="POST" action="processa/proc_cad_funcionarioadm.php">
		  ...
		  <div class="form-group">
			...
			<div class="col-sm-10">
			  <input type="email" class="form-control" name="HorarioInicio" placeholder="HH:MM:SS">
			</div>
		  </div>
		  ...
		  <div class="form-group">
			...
			<div class="col-sm-10">
			  <input type="password" class="form-control" name="NumSala" placeholder="Sala">
			</div>
		  </div>
